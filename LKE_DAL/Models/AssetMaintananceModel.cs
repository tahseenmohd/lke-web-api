    ...
    public class AssetMaintananceModel
    {
       ...
       //varchar(20)
        ...
        public AssetMaintananceModel(DataRow dr)
        {
            ...
            if (dr.Table.Columns.Contains("DateInService"))
            {
                if (!dr.IsNull("DateInService"))
                {
                    DateTime dateinService = (DateTime)Convert.ToDateTime(dr["DateInService"]);
                    this.DateInService = dateinService;
                }
                else
                {
                    this.DateInService = null;
                }
            }
